...
(function(){
  ...
  --------------------------------------------------------- */
  var CATEGORIES = [
    { name: "Hotels & Resorts", img: "assets/images/hotel/hotels-resorts.jpg", grad: "linear-gradient(160deg, rgba(31,58,61,.85), rgba(11,13,16,.9))", desc: "Turn rooms, views and hospitality into an unforgettable digital experience." },
  ...
  var PROJECTS = [
    ...
    {
      id: "aura-clinic", name: "Aura Clinic", industry: "Healthcare", layout: "split",
    ...
    {
      id: "local-co", name: "Local & Co.", industry: "Small Business", layout: "standard",
      img: "assets/images/business/local-co.jpg", grad: "linear-gradient(160deg, #c9a227, #1c1710)",
      ...
      heroImg: "assets/images/business/local-co-hero.jpg", heroGrad: "linear-gradient(160deg, #c9a227, #241d10)",
      sections: [
        { label: "What We Do", imgs: ["assets/images/business/local-co-what-1.jpg","assets/images/business/local-co-what-2.jpg","assets/images/business/local-co-what-3.jpg"], grad: ["#d9b64a","#4a3d1c","#c9a227"] },
        { label: "Get In Touch", imgs: ["assets/images/business/local-co-contact-1.jpg","assets/images/business/local-co-contact-2.jpg","assets/images/business/local-co-contact-3.jpg"], grad: ["#4a3d1c","#c9a227","#d9b64a"] }
      ],
  ...
  var SELECTOR_OPTIONS = [
    ...
    { key: "resort", label: "Resort", img: "assets/images/resort/selector-resort.jpg", headline: "Let your destination sell itself.", copy: "Large-format imagery and a slower pace of scroll, built for a place people are dreaming about before they book.", grad: "linear-gradient(160deg, #4a5a6b, #14171c)" },
    { key: "clinic", label: "Clinic", img: "assets/images/clinic/selector-clinic.jpg", headline: "Professional. Trustworthy. Accessible.", copy: "A calm, credible presentation of your services and team, designed to build confidence before the first appointment.", grad: "linear-gradient(160deg, #1f3a3d, #14171c)" },
    { key: "lodge", label: "Lodge", img: "assets/images/lodge/selector-lodge.jpg", headline: "A quiet stay, presented with care.", copy: "Natural tones and unhurried pacing that reflect what a lodge or homestay actually offers &mdash; a slower kind of hospitality.", grad: "linear-gradient(160deg, #2c4a34, #14171c)" },
    { key: "other", label: "Other", img: "assets/images/business/selector-other.jpg", headline: "Your business, its own visual language.", copy: "Every VisionX site starts from your brand and audience, not a template &mdash; tell us about your business and we'll shape the direction together.", grad: "linear-gradient(160deg, #5b4a8a, #14171c)" }
  ];
  ...
  function selectBusiness(key){
    ...
    selectorDisplay.innerHTML =
      ...
      '<div class="sel-content">' +
        ...
        '<p>' + opt.copy + '</p>' +
      '</div>' +
      '<div class="sel-visual">' + mediaHTML(opt.img, opt.label, opt.grad) + '</div>';
  }
